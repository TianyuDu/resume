...
\begin{tabular}{rl}
    ...
    - \textsc{Aug.} 2019 & Summer Session, Intensive Studies Program in Data Science\\
    	...
    	& \quad \textsc{Cumulative GPA}: 4.30/4.30; \textsc{Course Average}: 99\% \\
    \\
    % ========================================
...
\begin{itemize}
	\item Machine Learning Methods for Econometrics and Casual Inferences.
	\item Computational Economics, Game Theory, and Market Design.
	\item Machine Learning Methods and their Applications on Time Series Forecasting.
\end{itemize}

% Section: Activities
\section{Activities \& Projects}
\begin{tabular}{rl}
	\textsc{Jun.} 2019 & \textbf{Treatment Effect, Clustering, Classification, and Forecasting using PANSS data} \\
	- \textsc{Aiug.} 2019 & \emph{The Final Project for STATS202 at Stanford University} \\
	& \quad Positive and Negative Syndrome Scale (PANSS) scores of schizophrenia \\
	& patients were used to test treatment effects, clustering patients based on \\
	& prior-treatment scores. Moreover, SVM, random forests, and boosting machines \\
	& were developed to flag invalid assessments and forecast patients' future states.\\ 
...
\section{Skill Sheet}
	\begin{itemize}
		\item Programmings: Python including TensorFlow, PyTorch, Sci-kit Learn, Numpy, and various data visualization toolkits; R; STATA; Matlab; Mathematica; Bash.
