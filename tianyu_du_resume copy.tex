...
\\ \emph{The Final Project for STATS202 at Stanford University ($1^{st}$ place in class)}
...
\textbf{Programming Skills} Python (proficient in PyTorch, Sci-kit Learn, Pandas, Numpy, etc); R; STATA; Matlab; Mathematica; Bash; Git; Latex.
