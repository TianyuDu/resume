...
\descript{| Sep 2020 – Jun 2022 (Expected)}
...
\location{Summer Session, Intensive Studies in Data Science}
\begin{tightitemize}
...
\runsubsection{Research Student at SNAP}
\descript{| Sep 2020 - Present}
\location{Supervisor: Jure Leskovec, Mentor: Jiaxuan You}
\small{
}

\runsubsection{Research Student at Univ. of Toronto}
\descript{| Apr - Sep 2020}
\location{Supervisor: Ashton Anderson}
...
%------------------------------------------------
%\runsubsection{Patient data analysis on PANSS dataset}
%\descript{| Jun - Aug 2019}
%
